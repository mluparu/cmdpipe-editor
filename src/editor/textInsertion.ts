...
import { InsertionResult, EditorInfo } from '../types/extensionTypes';
...
export class TextInsertion {
    ...
    /**
     * Check if text can be inserted in the given editor
     */
    public canInsertInEditor(editorInfo: EditorInfo): boolean {
        return !editorInfo.isReadonly && !!editorInfo.editor;
    }
